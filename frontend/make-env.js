...
const envContents = {
  REACT_APP_CARAVAN_VERSION: appInfo.version,
  REACT_APP_CARAVAN_GIT_VERSION: gitVersion,
  REACT_APP_CARAVAN_PRODUCT_NAME: appInfo.productName,
  REACT_APP_ENABLE_REACT_QUERY_DEVTOOLS: 'false',
  REACT_APP_CARAVAN_SIDEBAR_DEFAULT_OPEN: 'true'
};
