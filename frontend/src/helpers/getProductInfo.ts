...
export function getVersion() {
  return {
    VERSION: import.meta.env.REACT_APP_CARAVAN_VERSION,
    GIT_VERSION: import.meta.env.REACT_APP_CARAVAN_GIT_VERSION,
  };
}
/**
...
export function getProductName(): string | undefined {
  return import.meta.env.REACT_APP_CARAVAN_PRODUCT_NAME;
}
