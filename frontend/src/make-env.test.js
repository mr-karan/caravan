...
test('Create & verify', () => {
  ...
  expect(keys).toContain('REACT_APP_CARAVAN_VERSION');
  expect(keys).toContain('REACT_APP_CARAVAN_GIT_VERSION');
  expect(keys).toContain('REACT_APP_CARAVAN_PRODUCT_NAME');
});
